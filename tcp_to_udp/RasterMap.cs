...
namespace tcp_to_udp
{
    public class RasterMap
    {
        ...
        static public (int[][], int[][][]) matches_two_cloud_ext(Point3d_GL[] points1, Point3d_GL[] points2,double resol = -1,double dist_max = -1)
        {
            var res1 = comp_resol(points1);
            var res2 = comp_resol(points1);
            var res = Math.Min(res1, res2);
        ...
        //ps1 static, move ps2
        public static Point3d_GL[] allign_meshes_simple(Point3d_GL[] ps1, Point3d_GL[] ps2, double max_dist, double triangle_size, double min_move, double min_rot)
        {
            var match_ind = new int[0][];
            var match_ind_ext = new int[0][][];
            (match_ind,match_ind_ext) = matches_two_cloud_ext(ps1, ps2,triangle_size,max_dist);//need indeces of cells, not ps
